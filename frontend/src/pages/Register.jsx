...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex overflow-hidden bg-gradient-to-r from-slate-50 via-blue-50 to-orange-50">
            

            {/* Left Section - White Card */}
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 pt-24">
                <div className="w-full max-w-md">
                    <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-lg border border-slate-100 backdrop-blur transform transition-all duration-500 hover:shadow-xl">
                        {/* Welcome Text */}
                        <h1 className="text-5xl lg:text-6xl font-bold text-blue-600 italic mb-6">
                            Welcome
                        </h1>
                        ...
                        <form onSubmit={handleSignup} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-blue-600 text-white font-bold py-3 rounded-full hover:bg-blue-700 hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
                            >
                        ...
                        <p className="text-center mt-6 text-slate-600 text-sm">
                            ...
                            <Link
                                to="/login"
                                className="text-cyan-500 font-bold hover:text-cyan-600 hover:underline transition-colors duration-200"
                            >
                                Sign in
                            </Link>
                        </p>
            ...
            >
                <div className="absolute inset-0 bg-gradient-to-t from-orange-600/20 to-transparent opacity-40"></div>
            </div>
        </div>
    );
};
